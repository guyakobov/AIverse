...
import { Cpu, Github, ArrowUpDown, Tag as TagIcon, X, Heart, LayoutGrid, Bookmark } from 'lucide-react';
...
const App: React.FC = () => {
    ...
    if (view === 'favorites') {
        ...
        if (recommendations.length > 0) {
            ...
            if (activeCategory !== 'All') {
                 tools = tools.filter(t => t.tool.category === activeCategory);
            }
        } else {
            let filtered = TOOLS;
            if (activeCategory !== 'All') {
            ...
            tools = filtered.map(t => ({ tool: t, reason: undefined }));
        }
    }
  ...
  }, [view, activeCategory, recommendations, sortBy, selectedTags, favorites]);
  ...
  const handleAISearch = async (query: string) => {
    ...
    const apiCall = getAIRecommendations(query, TOOLS);
                                ...
                                <div className="flex flex-col items-center gap-6 mb-10">
                                    ...
                                    <div className="flex flex-wrap justify-center gap-3">
                                        ...
                                        <button
                                            ...
                                            className={`relative px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ease-out transform flex items-center gap-2 active:scale-95 ${
                                            activeCategory === cat
                                        ...
                                        <div className="flex flex-wrap justify-center gap-2">
                                            {popularTags.slice(0, 15).map(tag => (
                                                <button
                                                    ...
                                                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 ease-in-out transform active:scale-95 ${
